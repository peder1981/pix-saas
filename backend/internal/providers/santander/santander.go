...
// Provider implementa o provider do Santander
type Provider struct {
	config     providers.ProviderConfig
	httpClient providers.HTTPClient
}

// NewProvider cria uma nova instância do provider Santander
...
func (p *Provider) Authenticate(ctx context.Context, credentials providers.ProviderCredentials) (*providers.AuthToken, error) {
...
func (p *Provider) RefreshToken(ctx context.Context, refreshToken string) (*providers.AuthToken, error) {
...
func (p *Provider) CreateTransfer(ctx context.Context, req *providers.TransferRequest) (*providers.TransferResponse, error) {
...
func (p *Provider) GetTransfer(ctx context.Context, req *providers.GetTransferRequest) (*providers.TransferResponse, error) {
...
func (p *Provider) CancelTransfer(ctx context.Context, req *providers.CancelTransferRequest) error {
...
func (p *Provider) CreateQRCodeStatic(ctx context.Context, req *providers.QRCodeRequest) (*providers.QRCodeResponse, error) {
...
func (p *Provider) CreateQRCodeDynamic(ctx context.Context, req *providers.QRCodeRequest) (*providers.QRCodeResponse, error) {
	return p.CreateQRCodeStatic(ctx, req)
}

// GetQRCode consulta um QR Code
func (p *Provider) GetQRCode(ctx context.Context, req *providers.GetQRCodeRequest) (*providers.QRCodeResponse, error) {
...
func (p *Provider) ValidatePixKey(ctx context.Context, req *providers.ValidatePixKeyRequest) (*providers.ValidatePixKeyResponse, error) {
...
func (p *Provider) GetSupportedMethods() []string {
	return []string{
		"transfer",
		"qrcode_static",
		"qrcode_dynamic",
